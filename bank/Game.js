...
export default class MainGame extends Phaser.Scene
{
    constructor ()
    {
        ...
        this.gameOverShown = false; // <<< WICHTIG
    }

    create ()
    {
        // <<< WICHTIG: alles sauber zurücksetzen
        this.isPaused = false;
    ...
    levelFail ()
    {
        ...
        this.sign.once('pointerdown', () => {

            // Szene komplett neu starten statt nur Menü
            this.scene.restart(); // <<< SAUBERSTER FIX
        });
    }
